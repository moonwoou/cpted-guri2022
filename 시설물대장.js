const items = {
	...
	쓰레기무단투기: [
		['쓰레기무단투기(2)', '쓰레기무단투기x01', '경기 구리시 수택동 528', 37.6008250000000, 127.1449194444440, ['전신주에 고정', '쓰레기 투기 녹화 CCTV']],
		['쓰레기무단투기(2)', '쓰레기무단투기x02', '경기 구리시 수택동 530', 37.6013444444444, 127.1441583333330, ['이동 감지 센서', '투기 금지 음성 방송']],
	],
	'CCTV-SOS': [
...
for (let ci = 0; ci < category.length; ci++) {
	...
	let article_title =
		`
	<div class="w3-container w3-indigo" style="margin-top:200px;height:200px;">
		<h1>시설물 관리대장</h1> 
		<h2 style="text-align:center;"><b>` +
		item[0][0].replace(/\(.*\)/gi, '') +
		`</b></h2> 
		<p class="txt-right">총 시설 수량 : ` +
		item.length +
		`개소</p> 
	</div>
...
`;
	...
	for (let i = 0; i < item.length; i++) {
		...
		let article_content =
			`
	<div class="w3-container w3-green" style="margin-top:20px">
		<h1>시설물 관리대장 > <b>` +
			element[0].replace(/\(.*\)/gi, '') +
			`</b></h1> 
		<p class="txt-right">` +
			(i + 1) +
			` / ` +
	...
	<div class="w3-half" style="margin-top:20px">
		...
		<div class="w3-container w3-card w3-white w3-margin-bottom">
			<h3>비고</h3>
			<p>` +
			(element[5][0] == undefined ? '' : '- ' + element[5][0]) +
			`</p>
			<p>` +
			(element[5][1] == undefined ? '' : '- ' + element[5][1]) +
			`</p>
			<p>` +
			(element[5][2] == undefined ? '' : '- ' + element[5][2]) +
			`</p>
			<p>` +
			(element[5][3] == undefined ? '' : '- ' + element[5][3]) +
			`</p>
			<p>` +
			(element[5][4] == undefined ? '' : '- ' + element[5][4]) +
			`</p>
			<p>` +
			(element[5][5] == undefined ? '' : '- ' + element[5][5]) +
			`</p>
			<p>` +
			(element[5][6] == undefined ? '' : '- ' + element[5][6]) +
			`</p>
			<p>` +
			(element[5][7] == undefined ? '' : '- ' + element[5][7]) +
			`</p>
			<p>` +
			(element[5][8] == undefined ? '' : '- ' + element[5][8]) +
			`</p>
			<p>` +
			(element[5][9] == undefined ? '' : '- ' + element[5][9]) +
			`</p>
		</div>
	</div>
	<div class="w3-half" style="margin-top:20px">
		<div class="w3-container w3-card w3-white w3-margin-bottom" style="height: 600px;">
			<img src="./images/` +
			element[0] +
			`/` +
			element[1] +
